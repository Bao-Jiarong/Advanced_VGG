'''
  ...
  Task         : Advanced VGG11, VGG13, VGG16, VGG19 Implementation
...
channel    = 3
n_outputs  = 10
model_name = "models/vgg13/digists"
...
# Step 1: Create Model
# model = vgg.VGG11((None,height, width, channel), classes = n_outputs, filters = 8)
model = vgg.VGG13((None,height, width, channel), classes = n_outputs, filters = 8)
# model = vgg.VGG16((None,height, width, channel), classes = n_outputs, filters = 8)
# model = vgg.VGG19((None, height, width, channel),  classes = n_outputs, filters = 8)
